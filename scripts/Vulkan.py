...
VULKAN_SDK_INSTALLER_URL = 'https://sdk.lunarg.com/sdk/download/1.3.216.0/windows/VulkanSDK-1.3.216.0-Installer.exe'
HAZEL_VULKAN_VERSION = '1.3.216.0'
VULKAN_SDK_EXE_PATH = 'TinyEngine/vendor/VulkanSDK/VulkanSDK.exe'
...
VulkanSDKDebugLibsURL = 'http://sdk.lunarg.com/sdk/download/1.2.170.0/windows/VulkanSDK-1.2.170.0-DebugLibs.zip'
OutputDirectory = "TinyEngine/vendor/VulkanSDK"
